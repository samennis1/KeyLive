...
import { CogIcon, CreditCardIcon } from '@heroicons/react/24/solid'
...
const navigation: navigationItem[] = [
  ...
  { name: 'Billing', href: "/dashboard/billing", icon: CreditCardIcon, current: false}
]
