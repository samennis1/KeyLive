...
import NavBase from '../layouts/NavBase';
...
const Pricing: NextPageWithLayout = () => {
  const tiers: tier[] = [{
    name: "Base",
    priceMonthly: 0,
    description: "For beginners and developers using sandbox testing environments",
    features: ["10 Product Activation Keys", "10 request/second rate limit", "Customer Support"],
    id: "1",
    href: "base"
  }, {
    name: "Pro",
    ...
    features: ["Unlimited Product Activation Keys", "100 request/second rate limit", "Priority Customer Support"],
    id: "2",
    href: "pro"
  }]
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            ...
            <p className="mt-6 text-lg leading-8 text-white/60">
              Boasting 99.9% uptime and world-class security features, who else to choose other than KeyLive.
            </p>
          </div>
        </div>
      </div>
